...
import ChatBox from "@/components/generatePage/chatPanel/ChatBox";
      ...
      <div className="w-full flex flex-col h-screen">
        <main className="flex-1 relative overflow-hidden">
          ...
          <div className="absolute inset-0 -z-10">
            {/* Static gradient (no heavy repainting) */}
            <div className="w-full h-full bg-gradient-to-br from-[#252268] via-[#732ff3]/80 to-[#6de7e1]/90" />

            {/* Subtle animated noise overlay (tiny perf cost) */}
            <div
              className="absolute inset-0 opacity-20 mix-blend-overlay animate-[pulse_6s_ease-in-out_infinite]"
          ...
          <div className="h-[calc(100vh-5rem)] relative z-10 flex flex-col items-center justify-center px-4 py-12 text-center gap-10 md:gap-12">
            <h1 className="relative text-4xl md:text-6xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-tr from-teal-200 via-purple-300 to-pink-400 drop-shadow-2xl animate-fadein-smooth">
